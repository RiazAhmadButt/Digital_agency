        ...
        <Row>
          <Col lg='6' md='6'>
            <div className='hero__content' data-aos='fade-up' data-aos-duration='2000'>
              ...
              <p style={{fontFamily:'Balsamiq Sans, cursive'}}>Where extraordinary ideas take flight, and ordinary is left behind. Welcome to our digital agency, where we turn imagination into realization, one byte at a time.</p>
